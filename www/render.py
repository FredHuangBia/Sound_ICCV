...
for r in range(6,8,1):
    for l in range(2,5,1):
        folder = "/data/vision/billf/object-properties/sound/sound/exp/objects/final100/R" + str(r) + "L" + str(l) +"/"
        for i in range(0,100,1):
            obj_path = folder + "obj-" + str(i) + ".obj"
            obj_name = str(i)+".orig"
            try:
                bpy.ops.import_scene.obj(filepath = obj_path)
                print('\033[93m' +  obj_path+'\033[0m')
            except:
                continue
            ...
            bpy.context.scene.render.filepath="/data/vision/billf/object-properties/sound/www_random/imgs/"+ "R" + str(r) + "L" + str(l) +"/" + str(i) + "_R" + str(r) + "L" + str(l) + ".png"
