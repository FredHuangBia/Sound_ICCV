...
motion = dict()
cfgPath = sys.argv[5]
skip_factor = sys.argv[6]
skip_factor = 1
# cfgPath = '/data/vision/billf/object-properties/sound/sound/result_v1_1/scene-1020/obj-1012-1015-1014-11-13/mat-4-4-4-0-0/sim/blender_render.cfg'
# cfgPath = '/data/vision/billf/object-properties/sound/sound/result_v1_1/scene-1011/obj-101-1005-15-45/mat-4-4-0-6/sim/blender_render.cfg'
config=configparser.ConfigParser()
config.read(cfgPath)
outPath = config.get('OutPath','outpath')
# outPath = '/data/vision/billf/object-properties/sound/zhengjia/render/1020-1012-4-1015-4-1014-4-11-0-13-0'
# outPath = '/data/vision/billf/object-properties/sound/zhengjia/render/1011-101-4-1005-4-15-0-45-6'
...
for objid in range(0,objnum):
    ...
    obj_path = obj_path.split('.')[0]+'.orig.obj'
    ...
    for x in range(len(current_obj.material_slots)):
        ...
        if mat.name[0:7]=='texture':
            ...
            dirs = obj_path.split('/')
            if int(dirs[-2])<1000:
                imgpath = os.path.join('/',*(dirs[0:-3]),'final100',dirs[-2],'images','%s.%s'%(filename,ext))
            else:
