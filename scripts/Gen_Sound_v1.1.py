...
class Obj:
    ...
    def ReadObj(self,objId):
        ...
        #    self.mass = 300
        if self.active == 1:
            self.objPath = os.path.join(self.ROOT,'data/ready','%d'%self.objId,'%d.orig_nt.obj'%self.objId)
        else:
...
if __name__ == '__main__':
    ...
    resultPath = os.path.join(ROOT,'result_v1_1','scene-%d'%sceneid,objResultPath,matResultPath)
