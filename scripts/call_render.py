...
filtered_cmd = open('/data/vision/billf/object-properties/sound/sound/script/render_entry_%d.txt'%(filtered_cmd_id),'r');
cmd_lines = []
...
for x in cmd_args:
	cmd.append('python /data/vision/billf/object-properties/sound/sound/script/Gen_Sound_New.py -s -c %s'%x)
for c in cmd:
	print c
